...
#    simulation = SimulationFlock(WORLDSIZE)
    simulation = TestingZoo(TILESIZE,WORLDSIZE, agentstatFile = file1 ,  printreproductiveAgent = True )
...
#    while counter < 10000:
    ...
    while GO:
        ...
        for event in pygame.event.get():
            ...
            print(" count:{}".format(counter)+"  N.Agents: {}".format(simulation.n_agent())+"   total energy: {}".format(round(simulation.total_agent_energy(),5)) +" [threshold:{:.4f}".format(simulation.pollen_threshold),end=' \n')
        counter += 1
